...
const TEXT_SYSTEM_PROMPT = `You are a professional student event extractor for schedules and syllabi.
...
Rules:
- Extract course numbers to put into the labels section which c
